            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="patient-provider">
                        <div class="patient-info">
                            ...
                            <div class="info-row">
                                ...
                                <div class="info-value">{{ $invoice->appointment->patient->full_name }}</div>
                            </div>
                        </div>
                        <div class="provider-info">
                            ...
                            <div class="info-row">
                                ...
                                <div class="info-value">{{ $invoice->appointment->doctor->full_name }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="services-table">
                        ...
                        <tbody>
                            <tr>
                                <td>{{ $invoice->appointment->appointmentType->name }}</td>
                                <td>{{ \Carbon\Carbon::parse($invoice->appointment->appointment_date)->format('M d, Y') }}</td>
                        ...
                        <table class="services-table">
                            ...
                            <tbody>
                                @forelse ($payments as $payment)
                                    <tr>
                                        <td>{{ $payment->invoice->appointment->id ?? 'N/A' }}</td> <!-- Appointment ID -->
