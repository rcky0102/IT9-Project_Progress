...
<head>
    ...
    <title>Appointment Types | Admin Settings | Medical Clinic</title>
        ...
        <div class="main-container">
            ...
            <aside class="settings-sidebar">
                ...
                <nav class="settings-nav">
                    ...
                    <a href="appointmenttypes-index.html" class="settings-nav-item active">
                        <i class="fas fa-list-alt"></i>
                        <span>Appointment Types</span>
                    </a>
                    <a href="departments-index.html" class="settings-nav-item">
